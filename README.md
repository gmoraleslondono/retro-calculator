...
When I was almost done a friend found a bug (`1 + 1 + 1 = 11`) so I quickly made some changes to fix it 🚀
I ended up moving the project to GitHub and added some end-to-end using [Cypress](https://www.cypress.io/) because after my quick fix this happened `1 + 1 = 0` 🙈
